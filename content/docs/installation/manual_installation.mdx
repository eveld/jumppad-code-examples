...
<Task id="manual_installation">
  Install version {{terraform_version}} of Terraform for Linux (AMD64) by downloading it from the <a href="https://developer.hashicorp.com/terraform/downloads?product_intent=terraform" target="_blank">downloads</a> page and installing it on the PATH.
</Task>